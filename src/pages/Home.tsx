...
/**
 * The home screen at `/`, `/archive`, `/custom`, `/stats` and `/timeline`: one route, one
 * `App`, opened on the tab the path names. One route rather than five so the URL can follow the pager as
