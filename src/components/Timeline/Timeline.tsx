 ...
 * above the first card and below the last is empty, and the line is the thing the player
  ...
  return (
    ...
    <div className="h-full relative">
      ...
      <div
        ...
        // `data-board-scroller` marks this node for the Playwright probes, which need the
        // element that actually scrolls and have no other stable handle on it: `board-center`
        // is also on the hand bar and on ArchivePanel.
        data-board-scroller
        className={`board-center h-full relative z-10 ${
          isDragging ? 'overflow-hidden' : 'overflow-y-auto timeline-scroll-vertical'
        }`}
      >
        <div ref={contentRef} className="relative flex flex-col items-start w-full">
