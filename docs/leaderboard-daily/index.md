...
- [2026-08-15 — Spoonerism Name Filter](session-2026-08-15-spoonerism-name-filter.md) — block slurs hidden in word-level wordplay ("Numb Digger"), which no character-level filter can see
...
- [Daily Sudden Death Update](daily-sudden-death-update.md) — legacy: daily mode switched to sudden-death rules
- [Bot Leaderboard Population](bot-leaderboard-population.md) — legacy: populating the leaderboard with bot scores
