...
│                     │                                       │    Functions       │
│ - GamePopup.tsx     │     GET /api/leaderboard/[date]      │                    │
│ - TopBar.tsx        │ ◄──────────────────────────────────── │ - submit.ts        │
│ - Leaderboard.tsx   │                                       │ - [date].ts        │
└─────────────────────┘                                       └────────┬───────────┘
                                                                       │
                                                              ┌────────▼───────────┐
                                                              │    Vercel KV       │
...
- Emoji grid has exactly `totalAttempts` characters (🟩 or 🟥)
